    ...
    <div class="container">
        ...
        <div class="sideMenu">
            ...
            <ul class="sideMenuList">
                ...
                <a href="ConfirmedGigs"><li class="sideList current">Confirmed Gigs</li></a>
                <a href="CreateGig"><li class="sideList">Create Gig</li></a>
            </ul>

        </div>
        <% Vector<Gig> getAllGigs = (Vector<Gig>) session.getAttribute("SKALLCGIGS");%>
        <div class="content">
            <c:forEach items="${SKALLCGIGS}" var="tempuser">
                    ...
                    <a href="ViewGig?g=${tempuser.getGigID()}" class="gigHover"><h3>${tempuser.getBandName()}</h3></a>
                        <c:choose>
                            <c:when test="${tempuser.getVoteCheck() eq 'NO'}">
                                ...
                                <h4 class="location">${tempuser.getVenueName()} <i class="fa fa-thumbs-up" id="voting"> ${tempuser.getVotes()}</i><form class = "voter"><input type="hidden" id="vote" name ="vote" value="${tempuser.getGigID()}"><input type="button" id = "voteButton" class="voteButton" name="voteButton" value="vote"></form></h4>
