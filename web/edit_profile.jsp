...
<body id="edit_profile">
    ...
    <div class="container">
        ...
        <h1>Edit Profile</h1>
        <form onsubmit="return validateEditProfile()" method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/UpdateProfile">
            ...
            <div class="bioCentre">
                ...
                <input name="email" id="userEmailEdit"  value="<%=getUser.getEmail()%>" type="email" onclick="return colourChange(email)" maxlength="25">
                <textarea class="textareaStyle" name="userpost" id="userpost" placeholder="Your Bio...."><%=getUser.getBio()%></textarea>
