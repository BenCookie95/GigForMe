 ...
 * @author Ben
 */
@WebServlet(name = "ViewBand", urlPatterns = {"/ViewBand"})
public class ViewProfile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(null == session.getAttribute("BAND")){
            ...
            Vector<Gig> allBandGigs = gDAO.getAllBandGigs(getBand.getBandID());

            request.getSession(true).setAttribute(Constants.SESSION_KEY_ALLBANDGIGS, allBandGigs);
            request.getRequestDispatcher("band_profile.jsp").forward(request, response);
        }
    }
