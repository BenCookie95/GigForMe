...
public class AllVenuesServlet extends HttpServlet implements Constants{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //response.sendRedirect("modify_venue.jsp");
        RequestDispatcher rd = request.getRequestDispatcher("modify_venue.jsp");
